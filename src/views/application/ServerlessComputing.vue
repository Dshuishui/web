...
const startThroughputTest = async () => {
  ...
  try {
    ...
    const senderPromise = fetch("http://127.0.0.1:30085/api/throughput/topic3-pro-kp-sender");
    const receiverPromise = fetch("http://127.0.0.1:30085/api/throughput/topic3-pro-kp-receiver");
